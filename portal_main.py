...
def generate_valid_serials():
    ...
    for i in range(2000, 2201):
        ...
        serials[serial_str] = {"name": f"الطالب رقم {i}", "track": "Plan A / Mid-Final"}
    return serials
...
def verify_serial(data):
    ...
    if serial in VALID_SERIALS:
        ...
        ACTIVE_STUDENTS[request.sid] = {"serial": serial, "name": student_info["name"]}
        ...
        emit('serial_verified_fail', {'status': 'rejected', 'message': 'الرقم التسلسلي غير صحيح أو غير مفعل في النظام!'})
